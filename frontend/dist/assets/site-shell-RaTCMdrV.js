const k=document.body.dataset.page||"",p=[{id:"home",href:"/",label:"Home"},{id:"about",label:"About Us",children:[["/about/#who-we-are","Who we are"],["/about/#our-history","Our History"],["/about/#our-team","Our Team"],["/get-involved/?interest=Partnership","Patners"],["/#story","Success Stories"]]},{id:"work",activePages:["work","amhs","sifa"],label:"What we Do",children:[["/our-work/#education","Education"],["/our-work/#health-care","Health Care"],["/our-work/#livelihood","Livelihood"]]},{id:"involved",activePages:["involved","sponsor","careers"],label:"Get Involved",children:[["/get-involved/#donate","Donate"],["/sponsor-a-child/","Sponsor a Child"],["/contact/?interest=Volunteer","Become a Volunteer"],["/careers/","Careers"]]},{id:"news",href:"/#news-and-updates",label:"News & Updates"},{id:"contact",href:"/contact/",label:"Contact Us"}],w=`
  ...
  <a class="brand brand--navbar" href="/" aria-label="AMEF home">
  ...
  </a>`,b=e=>(e.activePages||[e.id]).includes(k),x=p.map(e=>{const a=b(e);return e.children?`
    ...
    </div>`:`<a class="nav-link${a?" is-active":""}" href="${e.href}"${a?' aria-current="page"':""}>${e.label}</a>`}).join(""),S=p.map(e=>e.children?`
    <details class="mobile-nav-group"${b(e)?" open":""}>
    ...
    </details>`:`<a href="${e.href}">${e.label}</a>`).join(""),v=document.querySelector("[data-site-header]");v&&(v.outerHTML=`
    ...
    </header>`);const m=document.querySelector("[data-site-footer]");m&&(m.outerHTML=`
    <footer class="footer">
